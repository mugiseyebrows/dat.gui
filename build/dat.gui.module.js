...
var interpret = function interpret() {
  ...
  if (Common.isString(original)) {
    ...
    if (m !== null) {
      var rgba = m[1].split(',').map(function (e, i) {
        return i > 2 ? parseFloat(e) : parseInt(e, 10);
      });
      var valid = rgba.map(function (e, i) {
        return i > 2 ? validA(e) : validRgb(e);
      });
...
var ColorController = function (_Controller) {
  ...
  return _createClass(ColorController, [{
    key: "updateAlphaStyle",
    value: function updateAlphaStyle() {
      var _this$__color = this.__color,
        r = _this$__color.r,
        g = _this$__color.g,
        b = _this$__color.b;
    ...
    key: "updateInputStyle",
    value: function updateInputStyle() {
    ...
    value: function updateDisplay() {
      ...
      this.__temp.a = 1;
      var _this$__color3 = this.__color,
        r = _this$__color3.r,
        g = _this$__color3.g,
        b = _this$__color3.b;
        _this$__color3.a;
...
GUI$1._keydownHandler = function (e) {
  if (document.activeElement.type !== 'text' && document.activeElement.tagName !== 'TEXTAREA' && (e.which === HIDE_KEY_CODE || e.keyCode === HIDE_KEY_CODE)) {
    GUI$1.toggleHide();
  }
};
